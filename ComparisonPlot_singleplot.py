...
plt.title("Gráfico de 'rfax' para os arquivos selecionados")
plt.xlabel("Índice")
plt.ylabel("Valor 'rfax'")

# Plotar cada coluna no mesmo gráfico
for coluna in dados_completos.columns:
    plt.plot(dados_completos[coluna], label=coluna)
...
caminho_grafico = os.path.join(pasta_graficos, "grafico_selecionado.png")
